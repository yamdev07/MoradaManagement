...
<head>
    ...
    <style>
        ...
        .sidebar {
            background: linear-gradient(180deg, {{ $tenantColors['primary_color'] ?? '#8b4513' }} 0%, {{ $tenantColors['secondary_color'] ?? '#d2b48c' }} 100%) !important;
        ...
        .nav-item.active {
            background: linear-gradient(135deg, {{ $tenantColors['primary_color'] ?? '#8b4513' }} 0%, {{ $tenantColors['secondary_color'] ?? '#d2b48c' }} 100%) !important;
            border: 1px solid {{ $tenantColors['primary_color'] ?? '#8b4513' }} !important;
            color: #ffffff !important;
            box-shadow: 0 4px 12px {{ $tenantColors['primary_color'] ?? '#8b4513' }} !important;
        }
        ...
        .nav-item.active .nav-icon {
            background: linear-gradient(135deg, {{ $tenantColors['primary_color'] ?? '#8b4513' }} 0%, {{ $tenantColors['secondary_color'] ?? '#d2b48c' }} 100%) !important;
            color: #ffffff !important;
            box-shadow: 0 4px 8px {{ $tenantColors['primary_color'] ?? '#8b4513' }} !important;
        }
    ...
    <!-- Tenant Theme Script -->
    <script>
        window.tenantColors = @json($tenantColors);
    ...
    <title>@yield('title') - {{ $currentHotel->name ?? 'Morada Lodge' }} Admin</title>
...
<body class="sidebar-layout">
    ...
    <!-- Tenant Theme System -->
    <script src="{{ asset('js/tenant-theme.js') }}"></script>

    @if(request()->is('dashboard*') || request()->is('transaction*') || request()->is('room*') || request()->is('customer*') || request()->is('checkin*') || request()->is('availability*') || request()->is('profile*') || request()->is('reports*'))
        <script src="{{ asset('js/dashboard-spa.js') }}"></script>
        <script src="{{ asset('js/spa-toggle.js') }}"></script>
