...
.dc-header-icon {
    ...
    box-shadow: 0 4px 12px rgba(101,67,33,.3);
}
.dc-header-subtitle {
...
.step-item.active .step-bubble {
    ...
    color: white;
    box-shadow: 0 0 0 4px white, 0 4px 14px rgba(101,67,33,.35);
...
.form-control-dc:focus {
    border-color: var(--green-500);
    box-shadow: 0 0 0 3px rgba(205,133,63,.12);
}
.form-control-dc.error { border-color: var(--red-500); box-shadow: 0 0 0 3px rgba(101,67,33,.1); }
...
.btn-search:hover { background: #b87333; transform: translateY(-1px); }
...
.room-card.selected {
    border-color: var(--green-500);
    box-shadow: 0 0 0 3px rgba(205,133,63,.2), var(--shadow-md);
}
.room-card.selected::after {
    ...
    box-shadow: 0 2px 6px rgba(205,133,63,.4);
}
.room-img {
    height: 140px;
    background: var(--slate-100);
...
.warning-box {
    ...
    background: #fdf5ec; border: 1.5px solid #fde68a;
    border-radius: var(--radius-md);
...
.btn-dc-next:hover { transform: translateY(-2px); box-shadow: 0 6px 18px rgba(101,67,33,.38); }
.btn-dc-next:disabled {
    opacity: .5; cursor: not-allowed; transform: none;
    box-shadow: none;
}
.btn-dc-submit {
    background: linear-gradient(135deg, #4d3319, #b87333);
    display: inline-flex; align-items: center; gap: 8px;
    padding: 11px 28px; border-radius: var(--radius-sm);
    font-size: .9rem; font-weight: 700;
    color: white; border: none; cursor: pointer;
    transition: var(--transition);
    box-shadow: 0 4px 14px rgba(101,67,33,.35);
}
.btn-dc-submit:hover { transform: translateY(-2px); box-shadow: 0 8px 22px rgba(101,67,33,.4); }
...
.dc-info {
    ...
    font-size: .82rem; color: #cd853f; margin-bottom: 18px;
}
