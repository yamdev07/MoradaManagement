...
@section('title', 'Connexion - Check-Sys')
...
═════════════════════════════════════════════════════════════════ */
:root {
    --primary: {{ $tenantColors['primary_color'] ?? '#2c3e50' }};
    --primary-light: {{ $tenantColors['primary_color'] ?? '#2c3e50' }}dd;
    --primary-soft: {{ $tenantColors['primary_color'] ?? '#2c3e50' }}15;
    --secondary: {{ $tenantColors['secondary_color'] ?? '#3498db' }};
    --accent: {{ $tenantColors['accent_color'] ?? '#f39c12' }};
    --success: #27ae60;
    --warning: #f39c12;
    --danger: #e74c3c;
    --info: #17a2b8;
...
.btn-login:hover {
    ...
    box-shadow: 0 8px 25px {{ $tenantColors['primary_color'] ?? '#2c3e50' }}40;
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const tenantColors = @json($tenantColors);
