...
@section('title', 'Créer votre compte Hôtel - Check-Sys')
@section('content')
...
<div class="registration-container">
    <div class="registration-card">
        ...
        <div class="registration-right">
            ...
            <form id="tenantRegistrationForm" action="{{ route('tenant.register.submit') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-navigation">
                    <div style="display: flex; align-items: center; gap: 1rem;">
                        ...
                        <a href="{{ route('tenant.login.page') }}" class="btn-nav btn-register" style="display: flex; align-items: center; justify-content: center; text-decoration: none;">
