...
<div class="container-fluid">
    ...
    <div class="stats-row">
        ...
        <div class="stat-card">
            ...
            <div class="stat-value stat-value-success">{{ $activeSessions }}</div>
            <div class="stat-subtitle">En cours</div>
        </div>
        
        <div class="stat-card">
            <div class="stat-label">Chiffre d'affaires</div>
            <div class="stat-value stat-value-warning">{{ number_format($totalRevenue, 0, ',', ' ') }}</div>
        ...
        <div class="table-responsive">
            <table>
                ...
                <tbody>
                    ...
                    @endphp
                    <tr onclick="window.location='{{ route('cashier.sessions.show', $session) }}'" style="cursor: pointer;">
                        <td><strong>#{{ $session->id }}</strong></td>
                        <td>
                            <div class="user-info">
                                @if($session->user && $session->user->getAvatar())
                                    <img src="{{ $session->user->getAvatar() }}" class="user-avatar-sm" alt="">
                                @else
                        ...
                        <td>
                            ...
                            <span class="{{ $diffClass }}">
                                {{ $diffSign }}{{ number_format($difference, 0, ',', ' ') }}
                            </span>
