...
@section('title', 'Contact - ' . ($currentHotel->name ?? 'Morada Lodge'))
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="form-select" 
                                                    ...
                                                    <option value="chambre" {{ old('room_type') == 'chambre' ? 'selected' : '' }}>🛏️ Chambre Confort</option>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group mb-4">
                                            ...
                                            <textarea class="form-control" 
                                                      ...
                                                      style="border: 1px solid var(--secondary-brown, #6c757d); resize: vertical;">{{ old('message') }}</textarea>
                                            @error('message')
                                                <span class="text-danger small mt-1 d-block">{{ $message }}</span>
                                            @enderror
                                        </div>
                    ...
                    <div class="accordion" id="faqAccordion">
                        ...
                        <div class="accordion-item mb-4 border-0 shadow-sm" style="border-radius: 15px; overflow: hidden; background: white;">
                            ...
                            <div id="faq2" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                <div class="accordion-body" style="background-color: #fafafa; padding: 25px;">
                                    <p style="margin-bottom: 15px; font-size: 1rem;"><strong>Oui, {{ $currentHotel->name ?? 'Morada Lodge' }} accepte les animaux de compagnie</strong> (chiens et chats jusqu'à 8kg).</p>
