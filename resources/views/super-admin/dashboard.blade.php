...
<div class="dashboard-super">
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card" style="border-left: 4px solid var(--m500);">
            <div class="number">{{ $pendingTenants }}</div>
        ...
        <div class="col-12">
            <div class="top-tenants">
                ...
                <div class="top-tenant-item" style="background: var(--m50); border-radius: 8px; padding: 1rem;">
                    ...
                    <div style="text-align: right;">
                        <strong style="font-size: 1.1rem; color: var(--m600);">{{ $roleStats['Admin'] ?? 0 }}</strong>
                ...
                <div class="top-tenant-item" style="background: #f8f9fa; border-radius: 8px; padding: 1rem;">
                    ...
                    <div style="text-align: right;">
                        <strong style="font-size: 1.1rem; color: var(--m300);">{{ $roleStats['Receptionist'] ?? 0 }}</strong>
                ...
                <div class="top-tenant-item" style="background: #f0f0f0; border-radius: 8px; padding: 1rem;">
                    ...
                    <div style="text-align: right;">
                        <strong style="font-size: 1.1rem; color: #6c757d;">{{ $roleStats['Customer'] ?? 0 }}</strong>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge-role badge-receptionist">
                                        {{ $usersByRole['Receptionist'] ?? 0 }}
                                    </span>
                                </td>
                                <td>
                                    <span class="badge-role badge-customer">
                                        {{ $usersByRole['Customer'] ?? 0 }}
                                    </span>
                                </td>
                                <td>
                                ...
                                <td>
                                    <a href="{{ route('super-admin.users') }}?tenant_id={{ $tenant['id'] }}" 
                            ...
                            <tr style="background: var(--m50); font-weight: bold;">
                                ...
                                <td><strong>{{ $roleStats['Admin'] ?? 0 }}</strong></td>
                                <td><strong>{{ $roleStats['Receptionist'] ?? 0 }}</strong></td>
                                <td><strong>{{ $roleStats['Customer'] ?? 0 }}</strong></td>
