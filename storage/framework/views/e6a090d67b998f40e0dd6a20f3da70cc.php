...
<aside id="sidebar" class="sidebar">
    ...
    <a href="<?php echo e(route('dashboard.index')); ?>" class="sidebar-logo">
        <div class="d-flex align-items-center">
            <div class="">
                <img src="<?php echo e(asset('img/logo_cactus1.jpeg')); ?>"
                    alt="Hotel Cactus"
            ...
            <nav class="nav-menu">
                ...
                <div class="nav-section">
                    ...
                    <a href="<?php echo e(route('dashboard.index')); ?>"
                       class="nav-item <?php echo e($activeClass('dashboard.index')); ?>">
                        <div class="nav-icon">
                    ...
                    <?php if(in_array(auth()->user()->role, ['Super', 'Admin', 'Receptionist'])): ?>
                        <?php if(Route::has('availability.dashboard')): ?>
                        <a href="<?php echo e(route('availability.dashboard')); ?>"
                           class="nav-item <?php echo e($activeClass('availability.', false)); ?>">
                            <div class="nav-icon">
                ...
                <div class="nav-section">
                    ...
                    <?php if(Route::has('checkin.index')): ?>
                    <a href="<?php echo e(route('checkin.index')); ?>"
                       class="nav-item nav-item--highlight <?php echo e($isCheckinActive ? 'active' : ''); ?>">
                        <div class="nav-icon">
                    ...
                    <?php if(Route::has('transaction.reservation.createIdentity')): ?>
                    <a href="<?php echo e(route('transaction.reservation.createIdentity')); ?>"
                       class="nav-item nav-item--highlight <?php echo e($activeClass('transaction.reservation.createIdentity')); ?>">
                        <div class="nav-icon">
                ...
                <div class="nav-section">
                    ...
                    <?php if(Route::has('transaction.index')): ?>
                    <a href="<?php echo e(route('transaction.index')); ?>"
                       class="nav-item <?php echo e(($activeClass('transaction.', false) && !str_contains($currentRoute, 'transaction.reservation.')) ? 'active' : ''); ?>">
                        <div class="nav-icon">
                    ...
                    <?php if(Route::has('cashier.dashboard')): ?>
                    <a href="<?php echo e(route('cashier.dashboard')); ?>"
                       class="nav-item <?php echo e($activeClass('cashier.', false)); ?>">
                        <div class="nav-icon">
                    ...
                    <?php if(Route::has('restaurant.index')): ?>
                    <a href="<?php echo e(route('restaurant.index')); ?>"
                       class="nav-item <?php echo e($activeClass('restaurant.', false)); ?>">
                        <div class="nav-icon">
                ...
                <div class="nav-section">
                    ...
                    <?php if(Route::has('customer.index')): ?>
                    <a href="<?php echo e(route('customer.index')); ?>"
                       class="nav-item <?php echo e($activeClass('customer.index')); ?>">
                        <div class="nav-icon">
                    ...
                    <?php if(Route::has('room.index')): ?>
                    <a href="<?php echo e(route('room.index')); ?>"
                       class="nav-item <?php echo e($activeClass('room.index')); ?>">
                        <div class="nav-icon">
                        ...
                        <div class="nav-content">
                            ...
                            <div class="nav-subtitle">
                                <?php if(auth()->user()->role == 'Receptionist'): ?> Vue & État <?php else: ?> Gestion complète <?php endif; ?>
                            </div>
                        </div>
                    </a>
                    <?php endif; ?>

                    <?php if(Route::has('type.index') && in_array(auth()->user()->role, ['Super', 'Admin'])): ?>
                    <a href="<?php echo e(route('type.index')); ?>"
                       class="nav-item restricted <?php echo e($activeClass('type.index')); ?>">
                        <div class="nav-icon">
                    ...
                    <?php if(Route::has('payments.index')): ?>
                    <?php $isPaymentActive = $activeClass('payments.', false) || $activeClass('payment.', false); ?>
                    <a href="<?php echo e(route('payments.index')); ?>"
                       class="nav-item <?php echo e($isPaymentActive ? 'active' : ''); ?>">
                        <div class="nav-icon">
                    ...
                    <?php if(Route::has('reservation.index') && auth()->user()->role == 'Receptionist'): ?>
                    <a href="<?php echo e(route('reservation.index')); ?>"
                       class="nav-item <?php echo e($activeClass('reservation.index')); ?>">
                        <div class="nav-icon">
                ...
                <!-- ═══════════════════════════════════════
                     NETTOYAGE
                     ═══════════════════════════════════════ -->
                <?php if(in_array(auth()->user()->role, ['Super', 'Admin', 'Housekeeping', 'Receptionist'])): ?>
                <div class="nav-section">
                    <div class="nav-section-title">Nettoyage</div>

                    <?php if(Route::has('housekeeping.dashboard')): ?>
                    <a href="<?php echo e(route('housekeeping.dashboard')); ?>"
                       class="nav-item <?php echo e($activeClass('housekeeping.', false)); ?>">
                        <div class="nav-icon">
                    ...
                    <?php if(Route::has('roomstatus.index') && in_array(auth()->user()->role, ['Super', 'Admin'])): ?>
                    <a href="<?php echo e(route('roomstatus.index')); ?>"
                       class="nav-item <?php echo e($activeClass('roomstatus.index')); ?>">
                        <div class="nav-icon">
                    ...
                    <?php if(Route::has('facility.index') && in_array(auth()->user()->role, ['Super', 'Admin'])): ?>
                    <a href="<?php echo e(route('facility.index')); ?>"
                       class="nav-item <?php echo e($activeClass('facility.index')); ?>">
                        <div class="nav-icon">
                ...
                <div class="nav-section">
                    ...
                    <?php if(Route::has('user.index') && auth()->user()->role == 'Super'): ?>
                    <a href="<?php echo e(route('user.index')); ?>"
                       class="nav-item restricted <?php echo e($activeClass('user.index')); ?>">
                        <div class="nav-icon">
                    ...
                    <a href="<?php echo e(route('reports.index')); ?>"
                       class="nav-item <?php echo e($activeClass('reports.index')); ?>">
                        <div class="nav-icon">
                    ...
                    <?php if(Route::has('activity.index')): ?>
                    <a href="<?php echo e(route('activity.index')); ?>"
                       class="nav-item <?php echo e($activeClass('activity.index')); ?>">
                        <div class="nav-icon">
                ...
                <div class="nav-section">
                    ...
                    <a href="<?php echo e(route('profile.index')); ?>"
                       class="nav-item <?php echo e($activeClass('profile.', false)); ?>">
                        <div class="nav-icon">
                    ...
                    <?php if(auth()->user()->role == 'Customer' && Route::has('transaction.myReservations')): ?>
                    <a href="<?php echo e(route('transaction.myReservations')); ?>"
                       class="nav-item <?php echo e($activeClass('transaction.myReservations')); ?>">
                        <div class="nav-icon">
                    ...
                    <?php if(Route::has('notification.index')): ?>
                    <a href="<?php echo e(route('notification.index')); ?>"
                       class="nav-item <?php echo e($activeClass('notification.index')); ?>">
                        <div class="nav-icon">
                            <i class="fas fa-bell"></i>
                            <?php if(auth()->user()->unreadNotifications->count() > 0): ?>
                            <span class="nav-badge"><?php echo e(auth()->user()->unreadNotifications->count()); ?></span>
                            <?php endif; ?>
                        </div>
                        <div class="nav-content">
                    ...
                    <?php if(auth()->user()->role == 'Receptionist' && Route::has('receptionist.session.active')): ?>
                    <a href="<?php echo e(route('receptionist.session.active')); ?>"
                       class="nav-item <?php echo e($activeClass('receptionist.session.', false)); ?>">
                        <div class="nav-icon">
                        ...
                        <div class="nav-item nav-item--logout"
                             onclick="event.preventDefault(); 
                                      if (typeof Swal !== 'undefined') {
                                          ...
                                          alert('❌ Session active #<?php echo e($activeSession->id); ?>. Veuillez clôturer avant de vous déconnecter.');
                                      }"
                             style="cursor: pointer; opacity: 0.7;"
                             title="Déconnexion impossible - Clôturez d'abord votre session #<?php echo e($activeSession->id); ?>">
                            <div class="nav-icon">
                                <i class="fas fa-sign-out-alt" style="color: #ef4444;"></i>
                            </div>
                            <div class="nav-content">
                                <div class="nav-title" style="color: #ef4444;">Déconnexion (bloquée)</div>
                                <div class="nav-subtitle">Session #<?php echo e($activeSession->id); ?> active</div>
                            </div>
                        </div>
                    <?php else: ?>
        ...
        <div class="sidebar-footer">
            <div class="user-profile">
                <div class="user-avatar">
                    ...
                    <?php if($avatarPath): ?>
                        <img src="<?php echo e($avatarPath); ?>" 
                             alt="<?php echo e(auth()->user()->name); ?>"
                             onerror="this.onerror=null; this.src='https://ui-avatars.com/api/?name=<?php echo e(urlencode(auth()->user()->name)); ?>&background=059669&color=fff&size=40';">
                    <?php else: ?>
                    ...
                    <div class="user-role">
                        <?php switch(auth()->user()->role):
                            ...
                            <?php case ('Customer'): ?>
                                ...
                                <?php break; ?>
                            <?php default: ?>
                                <span class="badge bg-secondary"><?php echo e(auth()->user()->role); ?></span>
                        <?php endswitch; ?>
                    </div>
                    <?php if($hasActiveSession): ?>
                    <div class="session-indicator mt-1">
                        <small class="text-success">
                            <i class="fas fa-circle fa-xs"></i> Session #<?php echo e($activeSession->id); ?> active
                        </small>
                    </div>
                    <?php endif; ?>
                </div>
            ...
            <div class="datetime-info mt-2 pt-2 border-top border-white-10">
                <small class="text-white-50 d-block">
                    ...
                    <span id="sidebar-datetime"><?php echo e(now()->format('d/m/Y H:i')); ?></span>
                </small>
            </div>
        </div>
...
</script><?php /**PATH C:\Users\HP ELITEBOOK\Desktop\dev\Laravel-Hotel-main\resources\views/template/include/_sidebar.blade.php ENDPATH**/ ?>