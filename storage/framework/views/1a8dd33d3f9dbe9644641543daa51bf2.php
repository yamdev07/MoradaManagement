    ...
    <ul class="nav nav-tabs mb-4" role="tablist">
        <li class="nav-item">
            <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#pending">
                ...
                <span class="badge bg-primary"><?php echo e($pendingPayments->count()); ?></span>
            </button>
        </li>
        <li class="nav-item">
            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#sessions">
                <i class="fas fa-history me-1"></i> Mes sessions
                <span class="badge bg-primary"><?php echo e($recentSessions->count()); ?></span>
            </button>
        </li>
        <?php if($isAdmin): ?>
        <li class="nav-item">
                ...
                <div class="modal-body">
                    ...
                    <div class="summary-card">
                        ...
                        <div class="summary-item">
                            ...
                            <span class="summary-value text-primary"><?php echo e(number_format($activeSession->current_balance, 0, ',', ' ')); ?> FCFA</span>
                        </div>
                        <div class="summary-item">
...
<?php echo $__env->make('template.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Majorelle V\Documents\MoradaManagement\resources\views/cashier/dashboard.blade.php ENDPATH**/ ?>