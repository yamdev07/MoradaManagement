...
<?php $__env->startSection('title', 'Restaurant Gastronomique - cactus Palace'); ?>
    ...
    <section class="py-5 bg-light">
        <div class="container">
            ...
            <div class="row" id="menuList">
                ...
                <div class="col-lg-6 mb-4 menu-item" data-category="<?php echo e($menu->category); ?>">
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <p class="card-text text-muted"><?php echo e($menu->description); ?></p>
                                    <span class="badge bg-primary-custom">
                                        ...
                                        <?php else: ?> <?php echo e(ucfirst($menu->category)); ?>
...
$(document).ready(function() {
    ...
    $('#reservationForm').submit(function(e) {
        ...
        $.ajax({
            url: '<?php echo e(route("restaurant.reservation.store")); ?>',
            type: 'POST',
            data: formData,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP ELITEBOOK\Desktop\dev\Laravel-Hotel-main\resources\views/frontend/pages/restaurant.blade.php ENDPATH**/ ?>