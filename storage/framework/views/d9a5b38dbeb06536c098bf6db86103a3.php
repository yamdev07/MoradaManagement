...
<?php $__env->startSection('title', ($currentHotel->name ?? 'Morada Lodge') . ' - ' . ($currentHotel->description ?? 'Havre de Luxe au Cœur de la Nature')); ?>
                ...
                <div class="row min-vh-100 align-items-center justify-content-center">
                    <div class="col-lg-10 text-center">
                        <div class="hero-badge mb-4" data-aos="fade-down">
                            <span class="badge-text"><?php echo e($currentHotel ? $currentHotel->description : 'Le luxe au cœur de la nature'); ?></span>
                        </div>
                        <h1 class="hero-title mb-4" data-aos="fade-up" data-aos-delay="100">
                            <?php if(!empty($currentHotel)): ?> <?php echo e($currentHotel->name); ?> <?php else: ?> Morada Lodge <?php endif; ?>
                        </h1>
                        <p class="hero-subtitle mb-5" data-aos="fade-up" data-aos-delay="200">
                            <?php if(!empty($currentHotel)): ?> <?php echo e($currentHotel ? $currentHotel->description : 'Un sanctuaire de tranquillité où l\'élégance rencontre l\'authenticité africaine'); ?> <?php else: ?> Un sanctuaire de tranquillité où l'élégance rencontre l'authenticité africaine <?php endif; ?>
                        </p>
            ...
            <div class="row align-items-center g-5">
                    ...
                    <div class="intro-image-wrapper">
                        <div class="main-image">
                            <img src="<?php echo e(asset('img/room/Photo10.jpeg')); ?>" 
                                 alt="<?php echo e($currentHotel ? $currentHotel->name : 'Morada Lodge'); ?>" 
                                 class="img-fluid">
                        </div>
                ...
                <div class="col-lg-6" data-aos="fade-left">
                    <div class="section-header mb-4">
                        <span class="section-tag"><?php echo e($currentHotel ? $currentHotel->name : 'Morada Lodge'); ?></span>
                        <h2 class="section-title">Une expérience unique au Bénin</h2>
                    </div>
                    <p class="lead-text mb-4">
                        Situé à Covè, <?php echo e($currentHotel ? $currentHotel->name : 'Morada Lodge'); ?> offre un cadre paisible où nature, confort et hospitalité béninoise se rencontrent. 
                    ...
                    <p class="lead-text mb-4">
                        Que ce soit pour une escapade de détente ou un séjour spécial, <?php echo e($currentHotel ? $currentHotel->name : 'Morada Lodge'); ?> vous accueille 
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
                    <div class="testimonial-card-modern">
                        ...
                        <p class="testimonial-text">
                            La tranquillité du lieu et la qualité des services font de <?php echo e($currentHotel ? $currentHotel->name : 'Morada Lodge'); ?> une adresse incontournable. Nous reviendrons sans hésiter !
                        </p>
                        <div class="testimonial-author">
            ...
            <div class="cta-wrapper">
                <div class="row align-items-center">
                    <div class="col-lg-7" data-aos="fade-right">
                        <h2 class="cta-title">Vivez l'Expérience <?php echo e($currentHotel ? $currentHotel->name : 'Morada Lodge'); ?></h2>
                        <p class="cta-text">
...
<?php echo $__env->make('frontend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Majorelle V\Documents\MoradaManagement\resources\views/frontend/pages/home.blade.php ENDPATH**/ ?>