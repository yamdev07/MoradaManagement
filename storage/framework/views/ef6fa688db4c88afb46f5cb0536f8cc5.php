...
<div class="db-page">
    ...
    <div class="db-header anim-1">
        <div>
            <h1 class="db-header-greeting">
                Bonjour, <span><?php echo e(auth()->user()->name); ?></span> 👋
            </h1>
            <p class="db-header-sub">
                Vue d'ensemble des opérations · <?php echo e(now()->translatedFormat('l d F Y')); ?>

            </p>
        </div>
        <div class="db-header-right">
            <div class="db-time-block">
                <div class="db-time-date"><?php echo e(now()->translatedFormat('l d F')); ?></div>
                <div class="db-time-clock" id="db-clock"><?php echo e(now()->format('H:i')); ?></div>
            </div>
            <a href="<?php echo e(route('frontend.home')); ?>" target="_blank" class="btn-website">
    ...
    <div class="stats-grid anim-2">
        <a href="<?php echo e(route('transaction.index')); ?>?status=active&date_filter=today" class="stat-card stat-card--blue">
        ...
        <a href="<?php echo e(route('transaction.index')); ?>?status=completed&date_filter=today" class="stat-card stat-card--green">
            <div class="stat-card-top">
        ...
        <a href="<?php echo e(route('transaction.index')); ?>?payment_status=pending" class="stat-card stat-card--amber">
            <div class="stat-card-top">
        ...
        <a href="<?php echo e(route('transaction.index')); ?>?payment_status=urgent&due_within=24h" class="stat-card stat-card--red">
            <div class="stat-card-top">
            ...
            <div class="dates-grid">
                <a href="<?php echo e(route('checkin.index')); ?>?date=today" class="date-card date-card--today">
                    <div class="date-card-head">
                        ...
                        <span class="date-card-pill" style="background:var(--green-100);color:var(--green-800)"><?php echo e(now()->format('d M')); ?></span>
                    </div>
            ...
            <div class="rooms-grid">
                ...
                <a href="<?php echo e(route('reports.index')); ?>" class="room-stat-card">
                    ...
                    <div class="occupancy-bar">
                        <div class="occupancy-bar-fill" style="width:<?php echo e($stats['occupancyRate'] ?? 0); ?>%"></div>
                    </div>
                </a>
            </div>
        </div>
                    ...
                    <table class="db-table">
                        ...
                        <tbody>
                            ...
                            <tr class="<?php echo e($isNew ? 'row-new' : ''); ?>">
                                ...
                                <!-- Room -->
                                <td>
                                    <a href="<?php echo e(route('room.show', $transaction->room->id)); ?>" class="room-link">
                                        N° <?php echo e($transaction->room->number); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP ELITEBOOK\Desktop\dev\Laravel-Hotel-main\resources\views/dashboard/index.blade.php ENDPATH**/ ?>